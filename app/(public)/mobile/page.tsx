      ...
      <section className="section" style={{ paddingTop: 80 }}>
        <div className="container" style={{ maxWidth: 900 }}>
          <div style={{ textAlign: "center", marginBottom: 56 }}>
            ...
            <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
              <a href={ANDROID_URL} target="_blank" rel="noreferrer" style={{ textDecoration: "none" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, background: "#3DDC84", color: "#000", padding: "14px 28px", borderRadius: 14, fontWeight: 700, fontSize: 15 }}>
              ...
              <a href={IOS_URL} target="_blank" rel="noreferrer" style={{ textDecoration: "none" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, background: "var(--ink-a08)", color: "var(--text-primary)", border: "1px solid var(--border-default)", padding: "14px 28px", borderRadius: 14, fontWeight: 700, fontSize: 15 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20, marginBottom: 56 }}>
            {FEATURES.map(f => (
              <div key={f.h} style={{ background: "var(--surface-raised)", border: "1px solid var(--border-subtle)", borderRadius: 16, padding: 24 }}>
          ...
          <div style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap", paddingBottom: 80 }}>
            <a href={GITHUB_URL} target="_blank" rel="noreferrer" style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--text-secondary)", fontSize: 14, fontWeight: 500, border: "1px solid var(--border-default)", borderRadius: 10, padding: "10px 20px", textDecoration: "none" }}>
              <Download size={15} /> View on GitHub
            </a>
            <Link href="/connect" style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--orange-400)", fontSize: 14, fontWeight: 600, border: "1px solid var(--orange-400)", borderRadius: 10, padding: "10px 20px", textDecoration: "none" }}>
