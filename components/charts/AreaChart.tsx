      ...
      >
        <defs>
          <linearGradient id="tf-area" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="60%" stopColor="#FF8C00" stopOpacity="0.10" />
            <stop offset="100%" stopColor="#FF8C00" stopOpacity="0" />
          </linearGradient>
          <linearGradient id="tf-stroke" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#FFA333" />
        ...
        {hover != null && (
          <g>
            <line x1={xAt(hover)} x2={xAt(hover)} y1={padTop} y2={padTop + innerH}
              stroke="rgba(255,140,0,0.4)" strokeDasharray="3 3" />
            <circle cx={xAt(hover)} cy={yAt(data[hover])} r="5"
              fill="#FF8C00" stroke="#0a0a0a" strokeWidth="2" />
          </g>
        )}
